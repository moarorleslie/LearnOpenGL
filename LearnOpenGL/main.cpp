...
int main()
{
   ...
   //vertex shader
    ...
    //link both shader objects to shader program
    ...
    //no longer need these after linking them to shader program
    glDeleteShader(vertexShader);
    glDeleteShader(fragmentShader);


    //set up vertex data, buffers, and configure attributes
   ...
   //generate VBO to store vertex data
    unsigned int VBO;
    //generate VAO so that OpenGl knows what to do with our inputs
    unsigned int VAO;
